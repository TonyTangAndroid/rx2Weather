...
Rx2Weather is a sample Android Studio project demonstrating the use of
Retrofit2, RxJava2, Okhttp3, Retrolambda & RxLocation to interact with web services. 
[Link to the blog post](http://www.node.mu/2014/07/02/using-retrofit-and-rxjava-to-interact-with-web-services-on-android/).

based on [rex-weather](https://github.com/vyshane/rex-weather) with updated API.
...
The whole code is written based on [rex-weather](https://github.com/vyshane/rex-weather) library by Vy-Shane Sin Fat, which is under BSD license.